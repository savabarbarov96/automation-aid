    ...
    <section id="faq" className="py-24 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 animate-fade-in">
          <h2 className="text-4xl font-bold mb-4 text-[#000080]">Frequently Asked Questions</h2>
        ...
        <div className="max-w-3xl mx-auto animate-fade-in">
          <Accordion type="single" collapsible className="w-full space-y-4">
            {faqItems.map((item, index) => (
              ...
              >
                <AccordionTrigger className="text-left text-lg font-semibold text-[#000080]">
                  {item.question}
                </AccordionTrigger>
                <AccordionContent className="text-[#000080]">
                  {item.answer}
                </AccordionContent>
              </AccordionItem>
            ))}
