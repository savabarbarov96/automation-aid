    ...
    <section className="min-h-screen relative overflow-hidden flex items-center px-4 bg-background">
      ...
      <div className="container mx-auto relative pt-40">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="font-inter text-5xl md:text-7xl font-bold text-[#000080] mb-8 animate-fade-in leading-tight">
            Accelerating Business Growth Through Intelligent Automation
          </h1>
          <p className="text-xl md:text-2xl text-[#000080] mb-12 animate-fade-in max-w-3xl mx-auto" style={{ animationDelay: "0.2s" }}>
