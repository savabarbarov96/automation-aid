  ...
  return (
    <section className="min-h-screen relative overflow-hidden pt-40 pb-32 px-4">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -left-40 w-96 h-96 bg-primary/10 rounded-full blur-3xl animate-blob"></div>
        <div className="absolute top-0 -right-40 w-96 h-96 bg-accent/10 rounded-full blur-3xl animate-blob animation-delay-2000"></div>
        <div className="absolute -bottom-40 left-40 w-96 h-96 bg-primary/10 rounded-full blur-3xl animate-blob animation-delay-4000"></div>
      </div>
